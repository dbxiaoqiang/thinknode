 ...
 * @constructor
 */
Date.prototype.Timestamp = function (str) {
    var format = arguments.length <= 1 || arguments[1] === undefined ? 'yyyy-mm-dd hh:mi:ss' : arguments[1];
...
global.rmdir = function (p, reserve) {
    ...
    fs.readdir(p, function (err, files) {
        ...
        var promise = files.length === 0 ? getPromise() : _Promise.all(promises);
