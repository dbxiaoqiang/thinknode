...
exports.default = {
    ...
    cache: function cache(type, name, value) {
     ...
     * @constructor
     */
    F: function F(name, value, rootPath) {
    ...
    O: function O(http) {
        ...
        let type = arguments.length <= 3 || arguments[3] === undefined ? 'HTTP' : arguments[3];
     ...
     * @constructor
     */
    R: function R(name, http, data) {
        let list = THINK.HOOK[name] || [];
        let runItemMiddleware = (() => {
            var _ref = (0, _asyncToGenerator3.default)(function* (list, index, http, data) {
                let item = list[index];
                if (!item) {
                    return _promise2.default.resolve(data);
                }
                return _promise2.default.resolve(THINK.use(item, http, data)).then(function (result) {
                    if (result === null) {
                        return _promise2.default.resolve(data);
            ...
            return function runItemMiddleware(_x8, _x9, _x10, _x11) {
     ...
     * @constructor
     */
    S: function S(name, value, options) {
        try {
     ...
     * @constructor
     */
    X: function X(name, arg, config) {
        let layer = arguments.length <= 3 || arguments[3] === undefined ? 'Service' : arguments[3];
     ...
     * @param obj
     */
    adapter: function adapter(name, obj) {
     ...
     * @param name
     */
    addLogs: function addLogs(name, context) {
        try {
     ...
     * @returns {*}
     */
    walkFilter: function walkFilter(object) {
     ...
     * @return {}            []
     */
    parallelLimit: function parallelLimit(key, data, callback) {
