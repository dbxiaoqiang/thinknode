...
THINK.thinkRequire = function (name) {
    let type = arguments.length <= 1 || arguments[1] === undefined ? THINK.CACHES.ALIAS_EXPORT : arguments[1];
...
THINK.R = function (name, http, data) {
    ...
    let runItemMiddleware = (() => {
        ...
        return function runItemMiddleware(_x7, _x8, _x9, _x10) {
