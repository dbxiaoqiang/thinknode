...
exports.default = class extends _Base2.default {
    ...
    static createServer() {
        ...
        let server = _http3.default.createServer((() => {
            var _ref = (0, _asyncToGenerator3.default)(function* (req, res) {
                try {
                    ...
                    yield new THINK.App().exec(_http);
        ...
        if (THINK.config('use_websocket')) {
            try {
                let instance = new _WebSocket2.default({ server: server, app: this });
                instance.run();
            } catch (e) {
    ...
    exec(http) {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            ...
            http = yield _Dispather2.default.run(http);
    ...
    execController(http) {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            //app initialize
            yield THINK.run('app_init', http);
            //app begin
            yield THINK.run('app_begin', http);
