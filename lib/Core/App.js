...
exports.default = class extends _Base2.default {
        ...
        let server = _http3.default.createServer((() => {
            var _ref = (0, _asyncToGenerator3.default)(function* (req, res) {
                try {
                    ...
                    let dispCls = new _Dispather2.default(_http);
                    _http = yield dispCls.run();
                    yield self.exec(_http);
                    return THINK.statusAction(_http3.default, 200);
                } catch (err) {
                    return THINK.statusAction(_http3.default.runType ? _http3.default : httpCls.http, 500, err);
                }
            });
    ...
    execController(http) {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            ...
            yield _this.execAction(controller, http);
            //app end
