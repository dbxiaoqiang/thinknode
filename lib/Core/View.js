...
exports.default = class extends _Base2.default {
    ...
    display(templateFile, charset, contentType) {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            if (_this.http.isend) {
                return THINK.O(_this.http, 403, 'this http has being end', _this.http.isWebSocket ? 'SOCKET' : 'HTTP');
            }

            yield THINK.T('view_init', _this.http, [templateFile, _this.tVar]);
            let content = yield _this.fetch(templateFile);
            yield THINK.T('view_end', _this.http, [content, _this.tVar]);
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            ...
            if (THINK.isEmpty(templateFile) || !THINK.isFile(templateFile)) {
                ...
                if (!THINK.isFile(tpFile)) {
                    return THINK.O(_this2.http, 404, `can\'t find template file ${ tpFile }`, _this2.http.isWebSocket ? 'SOCKET' : 'HTTP');
                }
            }
            ...
            //内容过滤
            _this2.tVar = yield THINK.T('view_filter', _this2.http, _this2.tVar);
            //挂载所有变量到THINK.ViewVar
            THINK.ViewVar = _this2.tVar;
            //渲染模板
            return THINK.T('view_parse', _this2.http, { 'var': _this2.tVar, 'file': tpFile });
        })();
    }
}; /**
    *
