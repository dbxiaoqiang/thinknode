...
exports.default = class extends _Controller2.default {
    ...
    getAction() {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            if (!THINK.isEmpty(_this.id)) {
                try {
                    let pk = yield _this.model.getPk();
                    let data = yield _this.model.where(THINK.getObject(pk, _this.id)).find();
    ...
    deleteAction() {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            try {
                ...
                let rows = yield _this3.model.where(THINK.getObject(pk, _this3.id)).delete();
    ...
    putAction() {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            try {
                ...
                let rows = yield _this4.model.where(THINK.getObject(pk, _this4.id)).update(data);
