...
exports.default = class extends _Base2.default {
    ...
    exec(http) {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            ...
            try {
                yield _this3.execController(http);
    ...
    execController(http) {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            ...
            yield _this4.execAction(controller, http, {}, true);
            //app end
    ...
    execAction(controller, http, data, callMethod) {
        return (0, _asyncToGenerator3.default)(function* () {
            ...
            if (common_before && isFunction(controller[common_before])) {
                yield _promise2.default.resolve(controller[common_before]());
            }
            //当前action前置操作
            if (before && isFunction(controller[`${ before }${ http.action }`])) {
                yield _promise2.default.resolve(controller[`${ before }${ http.action }`]());
            }
