        ...
        return (0, _asyncToGenerator3.default)(function* () {
            try {
                ...
                if (!_this2.dbOptions.adapters[_this2.config.db_type]) {
                    return _this2.error(`adapters is not installed. please run 'npm install sails-${ _this2.config.db_type }'`);
                }
                //load collections
                ...
                //initialize
                let inits = promisify(THINK.ORM[_this2.adapterKey].initialize, THINK.ORM[_this2.adapterKey]);
            ...
            for (let field in data) {
                if (this.fields[field] && this.fields[field].type) {
                    switch (this.fields[field].type) {
                        case "integer":
                            !isNumber(data[field]) && result.push(`${ field }值类型错误`);
                            break;
                        case "float":
    ...
    add(data, options) {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            try {
                ...
                //copy data
                _this3._data = {};
                _this3._data = yield _this3.parseData(data, parsedOptions);
    ...
    update(data, options) {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            try {
                ...
                _this6._data = yield _this6.parseData(data, parsedOptions);
    ...
    find(options) {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            try {
                ...
                let result = {};
                if (!isEmpty(_this7.relation)) {
                    let process = model.find(_this7.parseDeOptions(parsedOptions));
                    if (!isEmpty(_this7._relationLink) && !isEmpty(parsedOptions.rel)) {
    ...
    select(options) {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            try {
                ...
                let result = {};
                if (!isEmpty(_this13.relation)) {
                    let process = model.find(_this13.parseDeOptions(parsedOptions));
                    if (!isEmpty(_this13._relationLink) && !isEmpty(parsedOptions.rel)) {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            try {
                ...
                if (_this15.config.db_type === 'mongo') {
                    ...
                    let cls = promisify(model.query, _this15);
