        ...
        return (0, _asyncToGenerator3.default)(function* () {
            try {
                ...
                if (!instances) {
                    ...
                    instances = yield inits(_this.dbOptions).catch(function (e) {
    ...
    add(data, options) {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            try {
                ...
                //copy data
                _this2._data = {};
                _this2._data = yield _this2.parseData(data);
                _this2._data = yield _this2._beforeAdd(_this2._data, parsedOptions);
                let result = yield model.create(_this2._data).catch(function (e) {
                    return _this2.error(`${ _this2.modelName }:${ e.message }`);
                });
                let pk = yield _this2.getPk();
                _this2._data[pk] = _this2._data[pk] ? _this2._data[pk] : result[pk];
                yield _this2._afterAdd(_this2._data, parsedOptions);
                return _this2._data[pk];
            } catch (e) {
    ...
    addAll(data, options) {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            try {
                ...
                _this3._data = yield _promise2.default.all(promisesd);

                let result = yield model.createEach(_this3._data).catch(function (e) {
    ...
    update(data, options) {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            try {
                ...
                _this5._data = yield _this5.parseData(data);
                _this5._data = yield _this5._beforeUpdate(_this5._data, parsedOptions);
                let pk = yield _this5.getPk();
                if (isEmpty(parsedOptions.where)) {
                    // 如果存在主键数据 则自动作为更新条件
                    if (!isEmpty(_this5._data[pk])) {
                        parsedOptions.where = getObject(pk, data[pk]);
                        delete _this5._data[pk];
                    } else {
                ...
                let result = yield model.update(parsedOptions, _this5._data).catch(function (e) {
                    return _this5.error(`${ _this5.modelName }:${ e.message }`);
                });
                yield _this5._afterUpdate(_this5._data, parsedOptions);
                let affectedRows = [];
                if (!isEmpty(result) && isArray(result)) {
                    result.forEach(function (v) {
                        affectedRows.push(v[pk]);
