...
exports.default = class extends _Base2.default {
    ...
    display(templateFile, charset, contentType) {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            if (_this.http.isend) {
                return O(_this.http, 403, 'this http has being end', _this.http.isWebSocket ? 'SOCKET' : 'HTTP');
            }
    ...
    fetch(templateFile) {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            ...
            if (isEmpty(templateFile) || !isFile(templateFile)) {
                ...
                if (!isFile(tpFile)) {
                    return O(_this2.http, 404, `can\'t find template file ${ tpFile }`, _this2.http.isWebSocket ? 'SOCKET' : 'HTTP');
                }
            }
