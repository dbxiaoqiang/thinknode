...
var _SocketRedisSocketJs = require('../Socket/RedisSocket.js');

var _SocketRedisSocketJs2 = _interopRequireDefault(_SocketRedisSocketJs);
...
var _default = (function (_cache) {
    ...
    _default.prototype.init = function init(options) {
        ...
        if (!(key in THINK.INSTANCES.REDIS)) {
            THINK.INSTANCES.REDIS[key] = _SocketRedisSocketJs2['default'](this.options);
        }
