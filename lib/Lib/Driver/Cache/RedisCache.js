...
exports.default = class extends _Cache2.default {
     ...
     */
    expire(name) {
        let timeout = arguments.length <= 1 || arguments[1] === undefined ? this.options.cache_timeout : arguments[1];
     ...
     */
    hSet(name, key, value) {
        let timeout = arguments.length <= 3 || arguments[3] === undefined ? this.options.cache_timeout : arguments[3];
     ...
     */
    hMget(name, key) {
        return this.handle.hMget(this.options.cache_key_prefix + name, key);
    }
