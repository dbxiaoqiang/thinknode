...
var MysqlDb = module.exports = Class(function () {
    'use strict';
    //数据库连接
    var dbConnections = {};
    //获取数据配置的基本信息
 ...
 * @return {[type]}        [description]
 */
MysqlDb.parseConfig = function (config) {
    'use strict';
    config = config || {};
    var conf = {
 ...
 * @return {[type]}        [description]
 */
MysqlDb.getInstance = function (config) {
    'use strict';
    var conf = this.parseConfig(config);
    var instance = MysqlDb(conf);
