...
var _class = function (_base) {
    ...
    _class.prototype.batchRm = function () {
        var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(keyword) {
            var keys;
            return _regenerator2.default.wrap(function _callee2$(_context2) {
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        ...
                        case 2:
                            keys = _context2.sent;
                            return _context2.abrupt('return', this.wrap('delete', [keys]));
