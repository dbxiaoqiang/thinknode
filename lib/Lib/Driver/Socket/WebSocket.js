...
var _ThinkHttpJs = require('../../Think/Http.js');

var _ThinkHttpJs2 = _interopRequireDefault(_ThinkHttpJs);
...
var _default = (function (_base) {
    ...
    _default.prototype.run = function run() {
        var io, messages, msgKeys, open, close;
        return _regeneratorRuntime.async(function run$(context$2$0) {
            var _this = this;

            while (1) switch (context$2$0.prev = context$2$0.next) {
                case 0:
                    io = _socketIo2['default'](this.server);
        ...
        return _regeneratorRuntime.async(function message$(context$2$0) {
            while (1) switch (context$2$0.prev = context$2$0.next) {
                case 0:
                    ...
                    request.url = url;
                    context$2$0.next = 5;
                    return _regeneratorRuntime.awrap(new _ThinkHttpJs2['default'](request, extend({}, request.res)).run());
