            ...
            return _regeneratorRuntime.async(function callee$2$0$(context$3$0) {
                while (1) switch (context$3$0.prev = context$3$0.next) {
                    ...
                    case 6:
                        ...
                        return context$3$0.abrupt('return', O(http, 500, context$3$0.t0, http.isWebSocket ? 'SOCKET' : 'HTTP'));
        ...
        return _regeneratorRuntime.async(function execController$(context$2$0) {
            while (1) switch (context$2$0.prev = context$2$0.next) {
                ...
                case 8:
                    ...
                    return context$2$0.abrupt('return', O(http, 404, 'Controller not found.'));
                ...
                case 16:
                    ...
                    return context$2$0.abrupt('return', O(http, 404, 'Controller ' + http.group + '/' + http.controller + ' not found.'));
        ...
        return _regeneratorRuntime.async(function execAction$(context$2$0) {
            while (1) switch (context$2$0.prev = context$2$0.next) {
                case 0:
                    ...
                    return context$2$0.abrupt('return', O(http, 404, 'action ' + http.action + ' not found.'));
