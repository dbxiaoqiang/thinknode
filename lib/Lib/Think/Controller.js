...
var _UtilFilter2 = _interopRequireDefault(_UtilFilter);
...
var _default = (function (_base) {
    ...
    _default.prototype.type = function type(ext) {
    ...
    _default.prototype.error = function error(errmsg, data) {
    ...
    _default.prototype.end = function end(obj, encoding) {
        return _regeneratorRuntime.async(function end$(context$2$0) {
            while (1) switch (context$2$0.prev = context$2$0.next) {
                ...
                case 3:
                    return context$2$0.abrupt('return', O(this.http, 200));
    ...
    _default.prototype.filter = function filter() {
        var _filter = _UtilFilter2['default'].filter;
    ...
    _default.prototype.valid = function valid(data, validType) {
        ...
        if (validType !== undefined) {
            ...
            var result = _UtilValid2['default'](data);
            return isEmpty(result);
        }
        return _UtilValid2['default'](data);
    };
