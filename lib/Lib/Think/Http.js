...
var _class = function (_base) {
            ...
            return _regenerator2.default.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        ...
                        case 7:
                            this.http = _context.sent;

                        case 8:
                            return _context.abrupt('return', getPromise(this.http));
    ...
    _class.prototype.bind = function bind() {
        var http = this.http;
    ...
    _class.prototype.cookie = function cookie(name, value, options) {
        ...
        if (name === true) {
            var _ret = function () {
                if (isEmpty(_this2._sendCookie)) {
                    return {
                        v: undefined
                    };
                }
                var cookieStringify = _this2.cookieStf;
                var cookies = (0, _values2.default)(_this2._sendCookie).map(function (item) {
                    return cookieStringify(item.name, item.value, item);
                });
                _this2.header('Set-Cookie', cookies);
                _this2._sendCookie = {};
                return {
                    v: undefined
                };
    ...
    _class.prototype.session = function () {
        var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(name, value) {
                ...
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        ...
                        case 4:
                            ...
                            return _context2.abrupt('return', this._session.set(name, value));
        ...
        return function session(_x2, _x3) {
            return ref.apply(this, arguments);
        };
    }();
    ...
    _class.prototype.end = function end() {
    ...
    _class.prototype.tplengine = function tplengine() {
        if (!this._engines) {
    ...
    _class.prototype.hasPostData = function hasPostData() {
    ...
    _class.prototype.getPostData = function getPostData() {
        if (this.hasPostData()) {
    ...
    _class.prototype._filePost = function _filePost() {
        var _this3 = this;
    ...
    _class.prototype._ajaxFilePost = function _ajaxFilePost() {
        var _this4 = this;
    ...
    _class.prototype._commonPost = function _commonPost() {
        var _this5 = this;
        ...
        this.req.on('end', function () {
            _this5.http.payload = Buffer.concat(buffers).toString();
            //解析提交的json数据
            _this5._jsonParse();
            //默认使用querystring.parse解析
            if (isEmpty(_this5.http._post) && _this5.http.payload) {
                _this5.http._post = _querystring2.default.parse(_this5.http.payload);
            }
            var post = _this5.http._post;
    ...
    _class.prototype._jsonParse = function _jsonParse() {
    ...
    _class.prototype._normalizePathname = function _normalizePathname(pathname) {
    ...
    _class.prototype._cookieParse = function _cookieParse() {
        'use strict';
    ...
    _class.prototype._cookieStringify = function _cookieStringify(name, value, options) {
        'use strict';
    ...
    _class.prototype._cookieUid = function _cookieUid(length) {
    ...
    _class.prototype._cookieSign = function _cookieSign(val) {
    ...
    _class.prototype._cookieUnsign = function _cookieUnsign(val, secret) {
    ...
    _class.prototype._sessionStore = function _sessionStore() {
        var sessionCookie = this.http._cookie[C('session_name')];
        //是否使用签名
        var sessionName = C('session_name');
        var sessionSign = C('session_sign');
        if (!sessionCookie) {
    ...
    _class.baseHttp = function baseHttp() {
