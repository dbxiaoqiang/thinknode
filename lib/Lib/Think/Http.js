...
var _default = (function (_base) {
    ...
    _default.prototype.session = function session(name, value) {
        var data;
        return _regeneratorRuntime.async(function session$(context$2$0) {
            while (1) switch (context$2$0.prev = context$2$0.next) {
                case 0:
                    if (this._session) {
                        context$2$0.next = 2;
                ...
                case 2:
                    ...
                    return context$2$0.abrupt('return', this._session.rm());
                ...
                case 4:
                    ...
                    return context$2$0.abrupt('return', this._session.set(name, value));

                case 10:
                    context$2$0.next = 12;
                    return _regeneratorRuntime.awrap(this._session.get(name));
    ...
    _default.prototype._cookieStringify = function _cookieStringify(name, value, options) {
        'use strict';
        options = options || {};
    ...
    _default.prototype._cookieUid = function _cookieUid(length) {
    ...
    _default.prototype._cookieSign = function _cookieSign(val) {
    ...
    _default.prototype._cookieUnsign = function _cookieUnsign(val, secret) {
    ...
    _default.prototype._sessionStore = function _sessionStore() {
