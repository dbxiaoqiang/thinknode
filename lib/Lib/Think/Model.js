...
exports.default = class extends _Base2.default {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            try {
                ...
                if (!instances) {
                    ...
                    instances = THINK.INSTANCES.DB[_this.adapterKey] = yield inits(_this.dbOptions).catch(function (e) {
                        return _this.error('connection initialize faild. please check the model property');
                    });
                }
    ...
    add(data, options) {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            try {
                ...
                //解析后的数据
                let parsedData = _this2.parseData(_this2._data);
                let result = yield model.create(parsedData);
    ...
    addAll(data, options) {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            try {
                ...
                let result = yield model.createEach(parsedData);
    ...
    delete(options) {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            try {
                ...
                let result = yield model.destroy(_this4.parseDeOptions(parsedOptions));
    ...
    update(data, options) {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            try {
                ...
                let parsedData = _this5.parseData(_this5._data);
                ...
                let result = yield model.update(parsedOptions, parsedData);
    ...
    count(options) {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            try {
                ...
                return model.count(_this7.parseDeOptions(parsedOptions));
            } catch (e) {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            try {
                ...
                if (!isEmpty(_this8.relation)) {
                    ...
                    result = yield model.find(_this8.parseDeOptions(parsedOptions));
                }
                return _this8._afterSelect(result || {}, parsedOptions);
            } catch (e) {
    ...
    countSelect(options, pageFlag) {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            try {
                ...
                let count = yield _this9.count(options);
                let pageOptions = _this9.parsePage(parsedOptions);
                ...
                //传入分页参数
                _this9.limit(pageOptions.page - 1 < 0 ? 0 : (pageOptions.page - 1) * pageOptions.num, pageOptions.num);
                let result = extend({ count: count, total: totalPage }, pageOptions);
                if (!parsedOptions.page) {
                    parsedOptions.page = pageOptions.page;
                }
                result.data = yield _this9.select(parsedOptions);
                return result;
            } catch (e) {
    ...
    query(sqlStr) {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            try {
                //safe mode
                _this10.config.db_ext_config.safe = true;
                // init model
                let model = yield _this10.initDb();
                let result = null;
                if (_this10.config.db_type === 'mongo') {
                    let quer = sqlStr.split('.');
                    if (isEmpty(quer) || isEmpty(quer[0]) || quer[0] !== 'db' || isEmpty(quer[1])) {
                        return _this10.error('query language error');
                    }
                    quer.shift();
                    let tableName = quer.shift();
                    if (tableName !== _this10.trueTableName) {
                        return _this10.error('table name error');
                    }
                    if (!THINK.INSTANCES.DB[_this10.adapterKey] || !THINK.INSTANCES.DB[_this10.adapterKey].collections || !THINK.INSTANCES.DB[_this10.adapterKey].collections[tableName]) {
                        return _this10.error('model init error');
                    }
                    model = THINK.INSTANCES.DB[_this10.adapterKey].collections[tableName];
                    let cls = promisify(model.native, model);
                    let process = yield cls();

                    let func = new Function('process', 'return process.' + quer.join('.') + ';');
                    process = func(process);
                    result = new _promise2.default(function (reslove, reject) {
                    ...
                    return result;
                } else if (_this10.config.db_type === 'mysql' || _this10.config.db_type === 'postgresql') {
                    result = promisify(model.query, _this10);
                    return result(sqlStr);
                } else {
                    return _this10.error('adapter not supported this method');
                }
            } catch (e) {
