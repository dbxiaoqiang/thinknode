    ...
    return {
        ...
        initDb: function () {
            ...
            if (!THINK.dbInstances[this.configKey]) {
                if (THINK.dbClient.collections && THINK.dbClient.collections.hasOwnProperty(self.trueTableName)) {
                    ...
                    THINK.dbClient.loadCollection(self.schema[this.trueTableName]);
