        ...
        return _regeneratorRuntime.async(function initDb$(context$2$0) {
            while (1) switch (context$2$0.prev = context$2$0.next) {
                ...
                case 8:
                    ...
                    return context$2$0.abrupt('return', this.error('model connections or collections error'));
        ...
        return _regeneratorRuntime.async(function query$(context$2$0) {
            ...
            while (1) switch (context$2$0.prev = context$2$0.next) {
                ...
                case 6:
                    ...
                    context$2$0.next = 11;
                    return _regeneratorRuntime.awrap((function callee$2$0() {
                        var quer, tableName, cls, process, func, result;
                        return _regeneratorRuntime.async(function callee$2$0$(context$3$0) {
                            while (1) switch (context$3$0.prev = context$3$0.next) {
                                case 0:
                                    quer = sqlStr.split('.');
