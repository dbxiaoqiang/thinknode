        ...
        return _regeneratorRuntime.async(function fetch$(context$2$0) {
            while (1) switch (context$2$0.prev = context$2$0.next) {
                ...
                case 3:
                    ...
                    return context$2$0.abrupt('return', tpFile);
                ...
                case 10:
                    ...
                    context$2$0.next = 15;
                    return _regeneratorRuntime.awrap(tVar[v]);

                case 15:
                    tVar[v] = context$2$0.sent;
                ...
                case 18:
                    context$2$0.next = 20;
                    return _regeneratorRuntime.awrap(T('view_parse', this.http, { 'var': tVar, 'file': templateFile }));

                case 20:
                    content = context$2$0.sent;
                    return context$2$0.abrupt('return', T('view_filter', self.http, content));
