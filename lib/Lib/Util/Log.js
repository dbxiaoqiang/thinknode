...
module.exports = Class(function () {
    ...
    return {
         ...
         * @return {[type]} [description]
         */
        getLogFile: function (name, path) {
            var date = this.getDate();
            path = path ? this.logPath + '/' + path : this.logPath + '/console';
            name = name ? name + '_' : '';
            //创建日志存放目录
            mkdir(path);
            var file = path + '/' + name + date + '.log';
            return file;
        },
        get2: function (str) {
