...
exports.default = {
     ...
     * @return {Boolean}     [description]
     */
    isNumberString: function isNumberString(obj) {
        "use strict";
     ...
     * @returns {boolean}
     */
    isJSONObj: function isJSONObj(obj) {
        "use strict";
     ...
     * @return {[type]}     [description]
     */
    getPromise: function getPromise(obj, reject) {
        "use strict";
     ...
     * @return {Boolean}      [description]
     */
    isWritable: function isWritable(p) {
        "use strict";
     ...
     * @returns {Promise}
     */
    mReadFile: function mReadFile(filename, enc) {
        "use strict";
     ...
     * @returns {Promise}
     */
    mWriteFile: function mWriteFile(filename, data) {
        "use strict";
     ...
     * @returns {Promise}
     */
    mReName: function mReName(filename, nfilename) {
        "use strict";
     ...
     * @return Promise
     */
    rmDir: function rmDir(p, reserve) {
        "use strict";
     ...
     * @return {[type]}      [description]
     */
    getFileContent: function getFileContent(file, encoding) {
        "use strict";
     ...
     * @return {[type]}      [description]
     */
    setFileContent: function setFileContent(file, data) {
        "use strict";
     ...
     * @return {[type]}           [description]
     */
    arrToObj: function arrToObj(arr, key, valueKey) {
        "use strict";
     ...
     * @returns {Array}
     */
    arrRemove: function arrRemove(array, toDeleteIndexes) {
        "use strict";
     ...
     * @return {[type]}      [description]
     */
    safeRequire: function safeRequire(file) {
        "use strict";
     ...
     * @constructor
     */
    cPrint: function cPrint(msg, type, showTime) {
        "use strict";
     ...
     * @returns {Promise.<*>}
     */
    use: function use(rule, http, data) {},
