...
var _App = require('./Lib/Think/App');

var _App2 = _interopRequireDefault(_App);

var _Controller = require('./Lib/Think/Controller');

var _Controller2 = _interopRequireDefault(_Controller);

var _Model = require('./Lib/Think/Model');

var _Model2 = _interopRequireDefault(_Model);

var _Service = require('./Lib/Think/Service');

var _Service2 = _interopRequireDefault(_Service);

var _Logic = require('./Lib/Think/Logic');

var _Logic2 = _interopRequireDefault(_Logic);

var _Behavior = require('./Lib/Think/Behavior');

var _Behavior2 = _interopRequireDefault(_Behavior);

var _View = require('./Lib/Think/View');
...
var _class = function () {
    ...
    _class.prototype.initialize = function initialize() {
    ...
    _class.prototype.loadAlias = function loadAlias(alias) {
        for (var v in alias) {
    ...
    _class.prototype.loadAliasExport = function loadAliasExport() {
        var alias = thinkCache(THINK.CACHES.ALIAS);
    ...
    _class.prototype.flushAlias = function flushAlias(type) {
    ...
    _class.prototype.flushAliasExport = function flushAliasExport(type) {
    ...
    _class.prototype.loadExt = function loadExt() {
    ...
    _class.prototype.loadCore = function loadCore() {
        var core = {
    ...
    _class.prototype.loadFramework = function loadFramework() {
        ...
        this.loadFiles({
            ...
            _this.loadAlias((_this$loadAlias = {}, _this$loadAlias[t] = f, _this$loadAlias));
        });
    ...
    _class.prototype.loadMoudles = function loadMoudles() {
        var _this2 = this;
        ...
        this.loadFiles({
            ...
            var _this2$loadAlias;

            _this2.flushAlias(t);
            _this2.flushAliasExport(t);
            _this2.loadAlias((_this2$loadAlias = {}, _this2$loadAlias[t] = f, _this2$loadAlias));
            if (g === 'Model') {
    ...
    _class.prototype.loadMoudleFiles = function loadMoudleFiles(group) {
        ...
        this.loadFiles({
            ...
            var _this3$loadAlias;

            _this3.flushAlias(t);
            _this3.flushAliasExport(t);
            _this3.loadAlias((_this3$loadAlias = {}, _this3$loadAlias[t] = f, _this3$loadAlias));
            if (g === 'Model') {
    ...
    _class.prototype.loadModels = function loadModels() {
        try {
            var modelCache = thinkCache(THINK.CACHES.MODEL);
        ...
        if (THINK.CONF.clear_require_cache) {
            (function () {
                ...
                setInterval(function () {
                    var _loop2 = function _loop2(file) {
            ...
            return _regenerator2.default.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        ...
                        case 6:
                            return _context.abrupt('return', new _App2.default().run());
