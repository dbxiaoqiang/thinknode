...
exports.default = class {
    ...
    initialize(options) {
        ...
        try {
            ...
            let packages = JSON.parse(_fs2.default.readFileSync(pkgPath, 'utf8'));
    ...
    loadFramework() {
        ...
        this.loadFiles({
            ...
            'Ext': [`${ THINK.THINK_PATH }/lib/Extend/`],
    ...
    run() {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            ...
            //加载挂载的中间件
            _this.loadExMiddleware();
            //初始化应用模型
            yield _this.initModel().catch(function (e) {
                return THINK.E(`Initialize App Model error: ${ e.stack }`, 'ERROR');
            });
