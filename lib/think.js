...
exports.default = class {
     ...
     */
    loadExt() {
        let extDir = `${ THINK.THINK_PATH }/Extend`;
        let tempDir = [];
        let fileDir = [];
        let tempName = '';
    ...
    loadFramework() {
        ...
        //加载框架类
        this.loadFiles({
            'Behavior': [`${ THINK.THINK_PATH }/Behavior/`],
            'Cache': [`${ THINK.THINK_PATH }/Driver/Cache/`],
            'Logs': [`${ THINK.THINK_PATH }/Driver/Logs/`],
            'Session': [`${ THINK.THINK_PATH }/Driver/Session/`],
            'Template': [`${ THINK.THINK_PATH }/Driver/Template/`]
        }, (t, f, g) => {
            this.loadAlias({ [t]: f });
        });
