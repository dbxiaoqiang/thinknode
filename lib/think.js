...
var _class = function () {
    ...
    (0, _createClass3.default)(_class, [{
        ...
        key: 'loadAlias',
        value: function loadAlias(alias, g) {
            ...
            for (var v in alias) {
                if (THINK.isObject(alias[v])) {
                    ...
                    if (g) {
                        ...
                        (0, _assign2.default)(THINK.CACHES[THINK.CACHES.ALIAS][g], (0, _defineProperty3.default)({}, v, alias[v]));
                    } else {
                        (0, _assign2.default)(THINK.CACHES[THINK.CACHES.ALIAS], (0, _defineProperty3.default)({}, v, alias[v]));
                    }
                }
            }
        }
        ...
        key: 'loadAliasExport',
        value: function loadAliasExport(alias) {
        ...
        key: 'loadAliasModel',
        value: function loadAliasModel(alias) {
        ...
        key: 'loadExMiddleware',
        value: function loadExMiddleware() {
        ...
        key: 'flushAliasExport',
        value: function flushAliasExport(g, type, file) {
        ...
        key: 'loadFiles',
        value: function loadFiles(ext, callback) {
        ...
        value: function loadFramework() {
            ...
            this.loadFiles({
                ...
                _this.loadAlias((0, _defineProperty3.default)({}, g, (0, _defineProperty3.default)({}, t, f)));
            });
        ...
        value: function loadApp() {
            ...
            this.loadFiles({
                ...
                _this2.loadAlias((0, _defineProperty3.default)({}, g, (0, _defineProperty3.default)({}, t, f)));
                if (g === 'Model') {
        ...
        key: 'parseMoudleList',
        value: function parseMoudleList() {
            var self = this;
        ...
        key: 'loadMoudleFiles',
        value: function loadMoudleFiles(group) {
            var _this3 = this;
            ...
            this.loadFiles({
                ...
                _this3.loadAlias((0, _defineProperty3.default)({}, g, (0, _defineProperty3.default)({}, t, f)));
                if (g === 'Model') {
                        ...
                        switch (_context.prev = _context.next) {
                            ...
                            case 2:
                                ...
                                return this.initModel().catch(function (e) {
                                    return THINK.error('Initialize App Model error: ' + e.stack);
                                });
