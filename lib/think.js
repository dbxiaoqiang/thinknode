...
var _class = function () {
    ...
    _class.prototype.loadFramework = function loadFramework() {
        ...
        //加载框架类
        this.loadFiles({
            'Adapter': [THINK.THINK_PATH + '/lib/Adapter/Cache/', THINK.THINK_PATH + '/lib/Adapter/Logs/', THINK.THINK_PATH + '/lib/Adapter/Session/', THINK.THINK_PATH + '/lib/Adapter/Template/', THINK.THINK_PATH + '/lib/Adapter/Socket/'],
