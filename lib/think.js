...
exports.default = class {
    constructor() {
        ...
        THINK = _function2.default.extend(false, {
    ...
    loadFramework() {
        //加载函数库
        THINK = _Lib2.default.extend(false, _function2.default, THINK);
        //加载核心
        let core = {
        ...
        this.loadFiles({
            ...
            'Adapter': [`${ THINK.THINK_PATH }/lib/Adapter/Cache/`, `${ THINK.THINK_PATH }/lib/Adapter/Logs/`, `${ THINK.THINK_PATH }/lib/Adapter/Session/`, `${ THINK.THINK_PATH }/lib/Adapter/Session/`, `${ THINK.THINK_PATH }/lib/Adapter/Template/`]
        }, (t, f, g) => {
            this.loadAlias({ [t]: f });
        });
