...
export default class extends base{
    init(http){
        ...
        this.options = {
            ...
            session_path: C('session_path'), //File类型下文件存储位置，默认为系统的tmp目录
    ...
    start(){
        let sessionCookie = this.http.cookie(this.options.session_name);
        //是否使用签名
        ...
        if (!sessionCookie) {
            ...
            //将生成的sessionCookie放在http._sendCookie对象上，方便程序内读取
